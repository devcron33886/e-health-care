    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>{{ $completed_appointments->count() }}</h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{ $cancelled_appointments->count() }}</h3>
        ...
        <div class="row">
            ...
            <section class="col-lg-6 connectedSortable">
                <div class="card">
                    <div class="card-header text-center">Latest Appointment</div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($appointment->appointment_status == 0)
                                                    <button class="btn btn-warning">Pendig</button>
            ...
            <section class="col-lg-6 connectedSortable">
                <div class="card">
                    <div class="card-header text-center">Latest Payments</div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
