        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.consultations.update", [$consultation->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('patient') ? 'is-invalid' : '' }}" name="patient_id" id="patient_id" required>
                        @foreach($patients as $id => $entry)
                            <option value="{{ $id }}" {{ (old('patient_id') ? old('patient_id') : $consultation->patient->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('symptom_one') ? 'is-invalid' : '' }}" type="text" name="symptom_one" id="symptom_one" value="{{ old('symptom_one', $consultation->symptom_one) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('symptom_two') ? 'is-invalid' : '' }}" type="text" name="symptom_two" id="symptom_two" value="{{ old('symptom_two', $consultation->symptom_two) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('symptom_three') ? 'is-invalid' : '' }}" type="text" name="symptom_three" id="symptom_three" value="{{ old('symptom_three', $consultation->symptom_three) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('symptom_four') ? 'is-invalid' : '' }}" type="text" name="symptom_four" id="symptom_four" value="{{ old('symptom_four', $consultation->symptom_four) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('doctor') ? 'is-invalid' : '' }}" name="doctor_id" id="doctor_id" required>
                        @foreach($doctors as $id => $entry)
                            <option value="{{ $id }}" {{ (old('doctor_id') ? old('doctor_id') : $consultation->doctor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
