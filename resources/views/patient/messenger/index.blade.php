@extends('patient.messenger.template')
        ...
        <div class="list-group">
            @forelse($topics as $topic)
                <div class="row list-group-item d-flex">
                    <div class="col-lg-4">
                        <a href="{{ route('patient.messenger.showMessages', [$topic->id]) }}">
                    ...
                    <div class="col-lg-1 text-center">
                        <form action="{{ route('patient.messenger.destroyTopic', [$topic->id]) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');">
