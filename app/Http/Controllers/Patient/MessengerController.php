...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('patient.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('patient.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('patient.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('patient.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('patient.messenger.reply', compact('topic', 'unreads'));
    }
